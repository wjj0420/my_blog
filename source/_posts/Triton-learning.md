...
![GPU 的线程、线程块与网格结构](Triton-learning/triton-gpu-structure.png)



![线程组织方式示意图](Triton-learning/triton-grid-block-thread.png)

![稀疏注意力示意图](Triton-learning/triton-sparse-attention.jpg)

![向量加法并行化示意图](Triton-learning/triton-vector-add.png)
